...
class UploadPhotoPage1 extends StatefulWidget {
  static const routeName = '/UploadPlzz';
  @override
  _UploadPhotoPage1State createState() => _UploadPhotoPage1State();
}

class _UploadPhotoPage1State extends State<UploadPhotoPage1> {
  File imageFile;
